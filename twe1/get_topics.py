...
#import gensim
import oldgensim.gensim as gensim2

def get_topics(walks_file, output_topic_file, number_of_topics, number_of_nodes):
    ...
    id2word = dict
    lda = gensim2.models.ldamodel.LdaModel(corpus=corpus, id2word=id2word, num_topics=number_of_topics)
